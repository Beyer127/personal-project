...
class Posts extends Component {
  ...
  editItem = (itemName, image, price, description, id) => {
    axios
      .put(`/api/item/${id}`, { itemName, image, price, description, id })
      .then(() => {
        ...
        <div key={e.item_id}>
          <Card style={{ width: "18rem", height: "40rem" }}>
            ...
            <Card.Body>
              ...
              <hr></hr>
              <div id="buttons">
                <Button className="button" onClick={() => this.handleEdit(e)}>
                  Edit
                </Button>
                <Button
                  className="button"
                ...
                <Button
                  className="button"
                  onClick={() => this.deleteItem(e.item_id)}
                >
                  Delete
                </Button>
              </div>
